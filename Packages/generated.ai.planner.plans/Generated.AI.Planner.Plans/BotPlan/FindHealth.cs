...
namespace Generated.AI.Planner.Plans.BotPlan
{
    ...
    struct FindHealth : IJobParallelForDefer
    {
        ...
        void GenerateArgumentPermutations(StateData stateData, NativeList<ActionKey> argumentPermutations)
        {
            ...
            var CollectibleFilter = new NativeArray<ComponentType>(1, Allocator.Temp){[0] = ComponentType.ReadWrite<Generated.AI.Planner.StateRepresentation.Collectible>(),  };
            ...
            for (int i0 = 0; i0 < AgentObjectIndices.Length; i0++)
            {
                ...
                if (!(AgentBuffer[AgentObject.AgentIndex].Health < 50f))
                    continue;
        ...
        float Reward(StateData originalState, ActionKey action, StateData newState)
        {
            var reward = 0f;
            {
                var param0 = originalState.GetTraitOnObjectAtIndex<Generated.AI.Planner.StateRepresentation.Agent>(action[0]);
                reward += new global::CollectHealthReward().RewardModifier( param0);
            }
